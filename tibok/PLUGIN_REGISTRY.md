# Tibok Plugin Registry

Community-created plugins for Tibok. All plugins are optional extensions that add new commands and functionality to the editor.

## How to Use This Registry

1. Find a plugin that interests you
2. Click the link to visit the GitHub repository
3. Download the latest release (usually a ZIP file)
4. Extract the plugin folder to `~/Library/Application Support/tibok/Plugins/ThirdParty/`
5. Restart Tibok
6. Go to Settings → Plugins and enable the plugin
...
Have a plugin to share? Open a GitHub issue with:
- **Plugin name**: My Awesome Plugin
- **Repository**: https://github.com/yourname/tibok-plugin-name
- **Description**: One-line summary of what it does
- **Author**: Your name
- **Version**: 1.0.0

We'll add it to this registry!
...
These plugins come with Tibok and are always available:

- **Core Slash Commands** (`com.tibok.core-slash-commands`) - 35+ markdown formatting commands
